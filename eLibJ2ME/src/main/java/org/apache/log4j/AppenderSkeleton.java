...
public abstract class AppenderSkeleton implements Appender, OptionHandler {
  ...
  /**
   * A string constant used in naming the option for setting the threshold for the appender. See also {@link #setThreshold setThreshold} method. Current value of this string constant is
   * <b>Threshold</b>.
   * <p>
  ...
  /**
   * Returns this appenders threshold priority. See the {@link #setThreshold} method for the meaning of this option.
   * @since 1.1
   */
  ...
  /**
   * Check whether the message priority is below the appender's threshold. If there is no threshold set, then the return value is always <code>true</code>.
   */
  ...
  /**
   * Set the layout for this appender. Note that some appenders have their own (fixed) layouts or do not use one.
   */
  ...
  /**
   * Configurable Appenders should override this method if they admit additional options. All classes derived from {@link AppenderSkeleton} admit the <b>Threshold</b> option, that is the value of the
   * string constant {@link #THRESHOLD_OPTION}. See {@link #setThreshold} method for the meaning of this option.
   */
   ...
   * <p>
   * In configuration files this option is specified by setting the value of the <b>Threshold</b> option to a priority string, such as "DEBUG", "INFO" and so on.
   * @since 0.8.3
   */
