...
public class AbsoluteTimeDateFormat { // extends Calendar

  protected Calendar calendar;

  /**
   * String constant used to specify {@link org.apache.log4j.helpers.AbsoluteTimeDateFormat} in
   * layouts. Current value is <b>ABSOLUTE</b>.
   */
  public final static String ABS_TIME_DATE_FORMAT = "ABSOLUTE";

  /**
   * String constant used to specify {@link org.apache.log4j.helpers.DateTimeDateFormat} in layouts.
   * Current value is <b>DATE</b>.
   */
  public final static String DATE_AND_TIME_DATE_FORMAT = "DATE";

  /**
   * String constant used to specify {@link org.apache.log4j.helpers.ISO8601DateFormat} in layouts.
   * Current value is <b>ISO8601</b>.
   */
   ...
   */
  public StringBuffer format(final Date date, final StringBuffer sbuf, final Object fieldPosition) { // FieldPosition
    // fieldPosition
    LogLog.debug("format:" + date.toString());// +";"+sbuf);
   ...
   */
  public Date parse(final String s, final Object pos) {// ParsePosition pos
    return null;
  }
}
