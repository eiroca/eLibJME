 ...
 * @author James P. Cakalic, Witmate
 * @since 0.8.2
 */
public class LoggingEvent {
   ...
   */
  public LoggingEvent(final Category category, final Priority priority, final Object message, final Throwable throwable) {
    fqnOfCategoryClass = category.getName();
