...
public abstract class Wml {
  ...
  public static WbxmlParser createParser() {
    ...
    p.setTagTable(0, Wml.TAG_TABLE);
    p.setAttrStartTable(0, Wml.ATTR_START_TABLE);
    p.setAttrValueTable(0, Wml.ATTR_VALUE_TABLE);
    return p;
  }

  public static WbxmlSerializer createSerializer() {
    final WbxmlSerializer s = new WbxmlSerializer();
    s.setTagTable(0, Wml.TAG_TABLE);
    s.setAttrStartTable(0, Wml.ATTR_START_TABLE);
    s.setAttrValueTable(0, Wml.ATTR_VALUE_TABLE);
    return s;
  }
