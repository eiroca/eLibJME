...
public class ParseException extends IOException {
  ...
  /*
   * Removed since super is not available in MIDP :( prints the own stack trace
   * followed by the stack trace of the original exception to the given
   * PrintStream public void printStackTrace (PrintStream p) {
   * super.printStackTrace (p); if (chained != null) chained.printStackTrace
   * (p); } /** prints the own stack trace followed by the stack trace of the
   * original exception to the given PrintWriter public void printStackTrace
   * (PrintWriter p) { super.printStackTrace (p); if (chained != null)
