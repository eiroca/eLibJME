...
public class ParseEvent {
  ...
  public ParseEvent(final int type, final String text) {
    this.type = type;
    this.text = text;
  }
  ...
  public Attribute getAttribute(final String namespace, final String name) {
    ...
    final Vector attributes = getAttributes();
  ...
  public Vector getAttributes() {
    throw new RuntimeException(ParseEvent.WRONG_TYPE);
  }
