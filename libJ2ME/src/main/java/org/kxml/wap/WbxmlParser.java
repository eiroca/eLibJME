...
public class WbxmlParser extends AbstractXmlParser {
  ...
  public WbxmlParser(final InputStream in) throws IOException {
    ...
    do {
      ...
      switch (id) {
        ...
        case Wbxml.STR_T: {
          ...
          next = new ParseEvent(Xml.TEXT, stringTable.substring(pos, end));
          break;
        }
        default:
  ...
  StartTag parseElement(final int id) throws IOException {

    final String tag = resolveId(tagTable, id & 0x03f);
